...
% Load file OR 
%--------------
PC3_01_OR = csvread('03_SeleksiFitur\PC3_OR\PC3_OR.csv');
...
%-------------
k = 5;
vektorPC3 = PC3_01_OR(:,1);
cvFolds = crossvalind('Kfold', vektorPC3, k);
clear vektorPC3; 
    
disp('PC3_OR Calculation in progress...');
...
%---
    ...
    %---            
        ...
        for iBarisData = 1 : size(PC3_01_OR,1)  %Iterasi baris data 
            %---- TRAINING
            if PC3_00_TrainIdx(iBarisData,iFold) == 1 %Kalau TrainIdx 1                 
                PC3_02_Train{1,iFitur}{iFold,1}(iTraining,1:iFitur) = PC3_01_OR(iBarisData,1:iFitur); %Sengaja dipisah kelasnya, karena ada iterasi fitur
                PC3_02_Train{1,iFitur}{iFold,1}(iTraining,iFitur+1) = PC3_01_OR(iBarisData,end); %Tambah kelas dari kolom paling terakhir di "PC3_01_OR"
            ...
            %---- TESTING
                ...
                PC3_03_Test{1,iFitur}{iFold,1}(iTesting,1:iFitur) = PC3_01_OR(iBarisData,1:iFitur); %Sengaja dipisah kelasnya, karena ada iterasi fitur           
                PC3_03_Test{1,iFitur}{iFold,1}(iTesting,iFitur+1) = PC3_01_OR(iBarisData,end); %Tambah kelas dari kolom paling terakhir di "PC3_01_OR"
...
PC3_57_MAX_Mean_BAL = [urutan nilai size(PC3_01_OR,2)-1 toc seed]; %Simpan ke 'PC3_57_MAX_Mean_BAL'
clear nilai urutan;
...
disp('Saving...');
    tic
        save('04_CBC\PC3_OR_CBC_FOLD_5.mat');        
    toc
disp('Done!');
